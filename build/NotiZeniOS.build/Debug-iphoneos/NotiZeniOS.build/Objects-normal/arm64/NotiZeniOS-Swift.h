...
#ifndef NOTIZENIOS_SWIFT_H
#define NOTIZENIOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NotiZeniOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class WCSession;
@class NSString;
SWIFT_CLASS("_TtC10NotiZeniOS25WatchConnectivityDelegate")
@interface WatchConnectivityDelegate : NSObject <WCSessionDelegate>
